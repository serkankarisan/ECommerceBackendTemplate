...
namespace Business.Concrete.Addresses
{
    public class CountryManager : ICountryService
    {
        ...
        {
            Country? result = await _countryDal.GetAsync(p => p.Id == id);
        ...
        {
            Country? updatedAddress = await _countryDal.GetAsync(p => p.Id == country.Id);
            if (updatedAddress == null)
                return new ErrorResult(Messages.NotFound);

            Country result = await _countryDal.UpdateAsync(updatedAddress);
        ...
        {
            Country result = await _countryDal.AddAsync(country);
        ...
        public async Task<IResult> DeleteAsync(int id)
        {
            ...
            Country result = await _countryDal.DeleteAsync(deletedCountry);
